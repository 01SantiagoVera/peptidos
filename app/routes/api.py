...
from database.db_mysql import save_query  # Asegúrate de tener esta función implementada
import datetime
...
def predict():
    try:
        ...
        print("Error en el procesamiento de la predicción:", e)  # Esto te ayudará a ver el error en la consola
